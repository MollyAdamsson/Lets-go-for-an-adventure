...
def start_game():
 ...
 ____ _           ______                               _ 
|_   _| |          |  _  \                             | |
  | | | |__   ___  | | | |__ _ _ __ ___  _ __   ___  __| |
  | | | '_ \ / _ \ | | | / _` | '_ ` _ \| '_ \ / _ \/ _` |
  | | | | | |  __/ | |/ / (_| | | | | | | | | |  __/ (_| |
  \_/ |_| |_|\___| |___/ \__,_|_| |_| |_|_| |_|\___|\__,_|
                                                          
 _    _ _ _ _                ______                  _    
| |  | (_) | |               |  ___|                | |   
| |  | |_| | | _____      __ | |_ ___  _ __ ___  ___| |_  
| |/\| | | | |/ _ \ \ /\ / / |  _/ _ \| '__/ _ \/ __| __| 
\  /\  / | | | (_) \ V  V /  | || (_) | | |  __/\__ \ |_  
 \/  \/|_|_|_|\___/ \_/\_/   \_| \___/|_|  \___||___/\__|                                                                                             
     """)    
...
def path_choice_2():
    ...
    a choice if the want to go to either path 3 or 4
    """
